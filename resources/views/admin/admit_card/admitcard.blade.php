            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                ...
                <div class="export-btn-area">
                    <a href="javascript:;" class="export_btn"
                        onclick="rightModal('{{ route('admin.admit_card.open_modal') }}', '{{ get_phrase('Create Admit Card') }}')">{{ get_phrase('+Create New Admit Card') }}</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8">
                                ...
                                class="img-fluid rounded-circle" width="200"> -->
                                                <img src="{{ asset('assets/images/person.png') }}" alt="person"
                                                    width="100%">
                                            </div>
                                        </div>
                                    </div>
