        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gr-15">
                <div class="d-flex flex-column">
                    <h4>{{ get_phrase('Print Admit Card
                        ') }}</h4>
    ...
    <div class="col-12">
        <div class="eSection-wrap">
            <div class="row mt-3">
                ...
                <div class="col-md-3">
                    <!-- <label for="Select Category" class="eForm-label">{{ get_phrase('Select Category') }}</label> -->
                ...
                <div class="col-md-3">
                    <!-- <label for="class_id_from" class="eForm-label">{{ get_phrase('Select Class') }}</label> -->
                ...
                <div class="col-md-3">
                    <!-- <label for="section_id_from" class="eForm-label">{{ get_phrase('Select a Section') }}</label> -->
                ...
                <div class="col-md-3 mt-4">
                    <!-- <label for="session_from" class="eForm-label">{{ get_phrase('Select A Session') }}</label> -->
                ...
                <div class="col-md-3 ">
                    <button class="eBtn eBtn btn-secondary mt-4" type="button" id="manage_student"
                        onclick="manage_student()">{{ get_phrase('Filter') }}</button>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2 text-center">
                            <!-- <img src="{{ asset('images/student-photo.jpg') }}" alt="Student Photo"
                                class="img-fluid rounded-circle" width="200"> -->
                            <img src="{{ asset('assets/images/person.png') }}" alt="person" width="100%">
                        </div>
                    </div>
                </div>
                <div class="text-center">
                    <hr>
                    <img src="{{ asset('assets/images/signature.png') }}" alt="Signature" width="20%">
