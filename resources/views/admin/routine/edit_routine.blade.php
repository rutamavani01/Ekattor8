    ...
    <div class="form-row">
        ...
        <div class="fpb-7">
            ...
            <select name="class_room_id" id="class_room_id_on_routine_creation"
                ...
                <option value="{{ $class_room['id'] }}" {{ $routine->room_id == $class_room['id'] ?  'selected':'' }}>
        ...
        <div class="fpb-7">
            ...
            <select name="day" id="day_on_routine_creation"
                ...
                <option value="saturday" {{ $routine->day == 'saturday' ?  'selected':'' }}>{{ get_phrase('Saturday') }}
                </option>
                <option value="sunday" {{ $routine->day == 'sunday' ?  'selected':'' }}>{{ get_phrase('Sunday') }}
                </option>
                <option value="monday" {{ $routine->day == 'monday' ?  'selected':'' }}>{{ get_phrase('Monday') }}
                </option>
                <option value="tuesday" {{ $routine->day == 'tuesday' ?  'selected':'' }}>{{ get_phrase('Tuesday') }}
                </option>
                <option value="wednesday" {{ $routine->day == 'wednesday' ?  'selected':'' }}>
                    {{ get_phrase('Wednesday') }}</option>
                <option value="thursday" {{ $routine->day == 'thursday' ?  'selected':'' }}>{{ get_phrase('Thursday') }}
                </option>
                <option value="friday" {{ $routine->day == 'friday' ?  'selected':'' }}>{{ get_phrase('Friday') }}
                </option>
            </select>
        </div>
