            ...
            <li
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <!-- <a class="{{ (request()->is('admin/promotion*')) ? 'active' : '' }}" -->
                        <a
                            href="{{ route('admin.admit_card.admitcard') }}"><span>{{ get_phrase('Admit Card') }}</span></a>
                    </li>
                    <!-- Print Admit Card -->
                    <li>
                        <a
                            href="{{ route('admin.admit_card.printadmitcard') }}"><span>{{ get_phrase('Print Admit Card') }}</span></a>
                    </li>
