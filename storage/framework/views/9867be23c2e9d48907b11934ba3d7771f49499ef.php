    ...
    <div class="form-row">
        <div class="fpb-7">
            ...
            <select name="class_id" id="class_id_on_routine_creation"
                ...
                <option value="<?php echo e($class['id']); ?>" <?php echo e($routine->class_id == $class['id'] ?  'selected':''); ?>>
        ...
        <div class="fpb-7">
            ...
            <select name="section_id" id="section_id_on_routine_creation"
                ...
                <option value="<?php echo e($section['id']); ?>" <?php echo e($routine->section_id == $section['id'] ?  'selected':''); ?>>
        ...
        <div class="fpb-7">
            ...
            <select name="teacher_id" id="teacher_on_routine_creation"
                ...
                <option value="<?php echo e($teacher['id']); ?>" <?php echo e($routine->teacher_id == $teacher['id'] ?  'selected':''); ?>>
        ...
        <div class="fpb-7">
            ...
            <select name="class_room_id" id="class_room_id_on_routine_creation"
                ...
                <option value="<?php echo e($class_room['id']); ?>" <?php echo e($routine->room_id == $class_room['id'] ?  'selected':''); ?>>
                    <?php echo e($class_room['name']); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="fpb-7">
            ...
            <select name="day" id="day_on_routine_creation"
                ...
                <option value="saturday" <?php echo e($routine->day == 'saturday' ?  'selected':''); ?>><?php echo e(get_phrase('Saturday')); ?>

                </option>
                <option value="sunday" <?php echo e($routine->day == 'sunday' ?  'selected':''); ?>><?php echo e(get_phrase('Sunday')); ?>

                </option>
                <option value="monday" <?php echo e($routine->day == 'monday' ?  'selected':''); ?>><?php echo e(get_phrase('Monday')); ?>

                </option>
                <option value="tuesday" <?php echo e($routine->day == 'tuesday' ?  'selected':''); ?>><?php echo e(get_phrase('Tuesday')); ?>

                </option>
                <option value="wednesday" <?php echo e($routine->day == 'wednesday' ?  'selected':''); ?>>
                    <?php echo e(get_phrase('Wednesday')); ?></option>
                <option value="thursday" <?php echo e($routine->day == 'thursday' ?  'selected':''); ?>><?php echo e(get_phrase('Thursday')); ?>

                </option>
                <option value="friday" <?php echo e($routine->day == 'friday' ?  'selected':''); ?>><?php echo e(get_phrase('Friday')); ?>
...
</script> ?><?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/admin/routine/edit_routine.blade.php ENDPATH**/ ?>