                    ...
                    <a href="<?php echo e(route('admin.dashboard')); ?>">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                style="enable-background:new 0 0 512 512;" xml:space="preserve" width="48" height="48">
                                <g>
                                    <path
            ...
            <li
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <!-- <a class="<?php echo e((request()->is('admin/promotion*')) ? 'active' : ''); ?>" -->
                        <a
                            href="<?php echo e(route('admin.admit_card.admitcard')); ?>"><span><?php echo e(get_phrase('Admit Card')); ?></span></a>
                    </li>
                    <!-- Print Admit Card -->
                    <li>
                        <a
                            href="<?php echo e(route('admin.admit_card.printadmitcard')); ?>"><span><?php echo e(get_phrase('Print Admit Card')); ?></span></a>
                    </li>
                    ...
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                id="alumni" class="bi bi-mortarboard mt-3">
                                <path
                    ...
                    <a href="#">
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-send mt-3" viewBox="0 0 16 16">
                                <path
                        ...
                        <div class="sidebar_icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <g>
                                    ...
                                    <path d="m45 49.83c-24.813 0-45 20.187-45 45v13h90v-13c0-24.813-20.187-45-45-45z" />
                                    <path d="m31.153 414.599c5.047 12.231 22.648 12.226 27.692 0l26.155-62.769h-80z" />
                                </g>
                            </svg>
                        </div>
                    ...
                    <div class="col-auto d-xl-block d-none">
                        <div class="header_notification d-flex align-items-center">
                            <div class="notification_icon">
                                ...
                                <img class=""
                                    src="<?php echo e(asset('assets/uploads/school_logo/'.DB::table('schools')->where('id', auth()->user()->school_id)->value('school_logo') )); ?>"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13.275"
                                                            ...
                                                            <g id="user_icon" data-name="user icon"
                                                                ...
                                                                <g id="Ellipse_1" data-name="Ellipse 1"
                                                                    transform="translate(1370.609 147.15)" fill="none"
                                                                    stroke="#181c32" stroke-width="2">
                                                                    <ellipse cx="4.576" cy="4.435" rx="4.576" ry="4.435"
                                                                        stroke="none" />
                                                                    <ellipse cx="4.576" cy="4.435" rx="3.576" ry="3.435"
                                                                        fill="none" />
                                                                </g>
                                                                <path id="Path_41" data-name="Path 41"
                                                                    d="M1485.186,311.087a5.818,5.818,0,0,1,5.856-4.283,5.534,5.534,0,0,1,5.466,4.283"
                                                                    transform="translate(-115.686 -149.241)" fill="none"
                                                                    stroke="#181c32" stroke-width="2" />
                                                            </g>
                                                        </svg>
                                                    </span>
...
</html><?php /**PATH C:\xampp\htdocs\Ekattor8\resources\views/admin/navigation.blade.php ENDPATH**/ ?>